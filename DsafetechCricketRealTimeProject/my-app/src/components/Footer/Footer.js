export const Footer = () => {
  return (
    <div className="px-4 pt-10 mx-auto  sm:max-w-xl md:max-w-full lg:max-w-screen-xl lg:absolute left-0 right-0 md:px-24 lg:px-8 bg-black bg-cover">
        ...
        <div className="md:max-w-md lg:col-span-2">
          ...
          <div className="mt-4 lg:max-w-sm">
            <p className="text-sm text-white">
              ...
              technological and economic shift in which software companies are
              poised to take over large swathes of the economy
            </p>
            <p className="mt-4 text-sm text-white">
              We will still be enormously profitable and by far the most
      ...
      <div className="flex flex-col justify-between pt-5 pb-10 border-t sm:flex-row">
        <p className="text-sm text-white">
          © Copyright 2023 Dsafetech. All rights reserved.
        </p>
